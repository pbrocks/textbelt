...
function App() {
	...
	return (
		<div className='min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 textbelt-app'>
				...
				{carriersError && (
					<div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6'>
						<p className='text-yellow-800'>
							<strong>Note:</strong> Unable to load carrier list:{" "}
							{carriersError}
						</p>
					</div>
				)}
					...
					<div className='space-y-6'>
						...
						<div className='bg-white rounded-lg shadow-md p-6'>
							...
							<div className='text-sm text-gray-700 space-y-2'>
								<p>
									TextBelt converts SMS messages to emails
									sent to carrier-specific gateways (e.g.,{" "}
								...
								<p>
									<strong>Automatic mode:</strong> Broadcasts
									to all carriers in the selected region,
									increasing delivery chances.
								</p>
								<p>
									<strong>Carrier mode:</strong> Targets a
									specific carrier's gateway if you know the
									recipient's carrier.
								</p>
								<p className='text-xs text-gray-500 mt-3'>
									Success means the email was sent to
									gateways, not guaranteed SMS delivery.
								</p>
							</div>
						</div>
						...
						<div className='bg-white rounded-lg shadow-md p-6'>
							...
							<ul className='text-sm text-gray-700 space-y-2'>
								<li>
									<strong>United States:</strong> AT&T,
									Verizon, T-Mobile, Sprint, and 10+ more
									carriers
								</li>
								<li>
									<strong>Canada:</strong> Rogers, Bell,
									Telus, Fido, and 50+ carriers
								</li>
								<li>
									<strong>International:</strong> 100+
									carriers worldwide (coverage varies)
								</li>
							</ul>
						</div>
					</div>
